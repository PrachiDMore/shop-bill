  ...
  return (
    <>
      <LayoutNew nav={true}>
        ...
        <div className="px-5 w-screen pt-20 relative z-50 h-[70vh] overflow-y-auto bg-red-4">
            ...
            {items.length > 0 ? (
              ...
              <div className=" mt-4   px-8  ">
                <div className="flex justify-around flex-col items-center">
                  ...
                  <div
                    className={`flex flex-col justify-center items-center   t${isDarkMode ? "text-white" : "text-gray-800"
                      } p-4`}
                  >
              ...
              <div className="grid grid-cols-2 gap-x-2 gap-y-2">
                <div className="flex-col  ">
                  ...
                  <input
                    ...
                    className={`w-full h-12  rounded-lg border  pl-2  bg-transparent ${isDarkMode ? " text-white" : " text-black"
                      }`}
                    required
                  />
                  {suggestedProducts.length > 0 && (
                    <ul className="absolute mt-0 w-[90vw] bg-white shadow-md rounded-lg border border-gray-300">
                ...
                <div className="flex-col ">
                  ...
                  <input
                    ...
                    className={`w-full h-12  rounded-lg border duration-200 pl-2 bg-transparent ${isDarkMode
                  ...
                  <select
                    ...
                    className={`ml-2 px-2 py-1 border rounded  ${isDarkMode
                      ? "text-white bg-gray-800"
                ...
                <div className="flex-col ">
                  ...
                  <input
                    ...
                    className={`w-full h-12  rounded-lg border duration-200 pl-2 bg-transparent ${isDarkMode ? " text-white" : " text-black"
                      }`}
                  />
                </div>
                <div className="flex-col ">
                  ...
                  {isTotalEditable ? (
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        value={total}
                        readOnly
                        className={`w-full h-12  rounded-lg border duration-200 pl-2 bg-transparent cursor-pointer ${isDarkMode ? " text-white" : " text-black"
                          }`}
